...
/>
                ...
                <Card
                    className={`xl:col-span-5 xl:col-start-5 macBook:col-span-6 macBook:col-start-6 ${pageType === 'primary' && !saleTimeEnded && "pt-0"
                        }`}
                >
                    {pageType === 'primary' && !saleTimeEnded && (
                        <div
                            className={cn(
                            ...
                            <div className="flex md:col-span-3 w-full border-t p-3">
                                <div className="flex sm:items-center justify-between flex-col sm:flex-row gap-4 w-full">
                                    ...
                                    <div className="flex flex-1 flex-wrap sm:justify-end items-center gap-1">
                                        <Badge>
                                            Price Per Share: ${product.pricePerShare.toLocaleString()}
                                        </Badge>
